...
<div class="flex flex-col">
    ...
    @can('create', \App\Models\Variacion::class)
        <div class="p-4 mb-3">
            <button type="button" class="text-white bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"><a href="{{ route('admin.variacion.create') }}" class="px-4 py-2 mb-4">Añadir Variación </a></button>
        </div>
    @endcan
