    ...
    @csrf 
        <div class="px-4 py-4 my-4 bg-violet-50 rounded-lg shadow-md flex flex-col md:flex-row mx-auto"> <!-- Div información derecha -->
            <div class="w-full md:w-1/2 md:pr-4">
                <label class="shadow appearance-none border rounded w-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-white flex justify-center cursor-pointer">
