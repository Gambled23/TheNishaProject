                            ...
                            <tr class="border-b transition duration-300 ease-in-out hover:bg-neutral-100">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 font-medium"> 
                                    <form action="{{ route('admin.producto.edit', $producto) }}" method="GET">
                                        <button type="submit" class="text-black bg-white-700 hover:bg-gray-200 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2">
