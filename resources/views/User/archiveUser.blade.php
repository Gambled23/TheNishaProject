...
<div class="flex flex-col">
    <h1 class="text-center mb-10 text-2xl font-mono"><br>users</h1>
                    ...
                    <table class="min-w-full text-left text-sm font-light">
                        <thead class="border-b font-medium dark:border-neutral-500">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-4">Fecha de eliminación</th>
                            </tr>
                        </thead>
                        <tbody>
                        @foreach ($users as $user)
                            ...
                            <tr class="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 font-medium max-w-[200px] overflow-hidden overflow-ellipsis">{{$user->email}}</td>
                                <td class="whitespace-nowrap px-6 py-4 font-medium">{{ $user->deleted_at }}</td>
                                ...
                                @can('soft_db')
                                    <td><form action="/user/{{ $user->id }}/restore" method="POST">
                                        @csrf
                                        <button type="submit" class="text-black bg-white-700 hover:bg-gray-200 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        <i class="ri-database-2-line"> </i>  Restaurar </button>
                                    </form></td> 
                                @endcan
