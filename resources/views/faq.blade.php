...
<section class="px-14">
    ...
    <ul class="space-y-4">
        ...
        <li>
            ...
            <p class="text-gray-600">La realización del producto puede tardar un par de días hasta un par de semanas, dependiendo la complejidad del producto</p>
        </li>
        <li>
        ...
        <li>
            ...
            <p class="text-gray-600">Sí!, si quieres hablar sobre un producto personalizado puedes comunicarte por DM en <a href="https://www.instagram.com/nisha_crochet/" target="_blank" class="text-violet-800 hover:text-violet-950">instagram</a></p>
        </li>
        <li>
