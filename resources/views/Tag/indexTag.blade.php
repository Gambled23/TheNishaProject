                    ...
                    <table class="min-w-full text-left text-sm font-light">
                        ...
                        @foreach ($tags as $tag)
                            ...
                            <tr class="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 font-medium"><a href ="{{ route('tag.show', $tag)}}">{{ $tag->nombre }}</a></td> 
                                ...
                                </svg>  <a href ="{{ route('tag.edit', $tag)}}">Editar</button>
                                </td>
                                <td><form action="{{ route('tag.destroy', $tag )}}" method="POST">
                                    @csrf
                                    @method('DELETE')
